...
class SignIn(QWidget):
    ...
    def __init__(self,on_sign_in_completed):
        ...
        self.signin = SignInPage(self.loginSuccess, self.move_on)
...
class SignInPage(QWidget):
    ...
    def __init__(self, loginSuccess, move_on):
        super().__init__()
        self.hide_pass = None
        self.show_pass = None
        self.companies = None
...
class CompanyPage(QWidget):
    ...
    def handle_company_selection(self):
        ...
        threading.Thread(target=self.continue_with_selected_company).start()
